...
namespace DialogueEditor
{
	public class ConversationManager : MonoBehaviour
	{
		...
		private void Update()
		{
			switch (m_state)
			{
				...
				case eState.Idle:
				{
					...
					{
						if (m_currentSpeech.Dialogue != null || m_currentSpeech.Options == null ||
						    m_currentSpeech.Options.Count == 0)
						{
		...
		public void DoSpeech(SpeechNode speech)
		{
			...
			AudioManager.Instance.PlayRandomSoundAtPosition(AudioManager.SoundType.Speech, transform.position);
